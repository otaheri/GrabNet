...
class PointNet2ClsMsg(nn.Module):
    def __init__(self):
        ...
        self.sa1 = PointNetSetAbstractionMsg(512, [0.1, 0.2, 0.4], [16, 32, 128], 1,
...
class PointNet2PartSeg_msg_one_hot(nn.Module):
    def __init__(self, num_classes):
        ...
        self.sa1 = PointNetSetAbstractionMsg(512, [0.1, 0.2, 0.4], [32, 64, 128], 0+32, [[32, 32, 64], [64, 64, 128], [64, 96, 128]])
