...
class BHOC_DS(Dataset):
    def __init__(self, dataset_dir, ):
        ...
        self.object_names = np.load(os.path.join(dataset_dir, 'contact_maps_object_names.npz'))['object_names']
...
if __name__ == '__main__':
    ...
    batch_size = 256
    dataset_dir = '/ps/scratch/body_hand_object_contact/bhoc_network/data/V01_02_00/test'
    ...
    for i_batch, sample_batched in tqdm(enumerate(dataloader)):
        ...
        idx = data['idx']
        print(ds.data_info['contact_maps_fnames'][idx])
